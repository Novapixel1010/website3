...
import sty from "./PlasmicButton.module.css"; // plasmic-import: PO4QgpURk8PT/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___0M6Aj, {
          [sty.freeBoxcolor_neutral___0M6AjsVtpT]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered___0M6Ajfl1RFIHf24]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull___0M6AjabHZp]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge___0M6AjPp2Dy]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall___0M6Aj75E2B]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large___0M6AjKSdZ]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small___0M6AjsGdNz]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered___0M6AjiHf24]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__xPm8, {
            [sty.freeBoxcolor_neutral__xPm8SVtpT]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__xPm847Jxk]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__xPm8Pp2Dy]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__xPm8KSdZ]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__xPm8SGdNz]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__xPm8IHf24]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__xPm87S3FwSVtpT]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__miGpR)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__aOarh, {
            [sty.freeBoxiconEnd__aOarhsv5Tq]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__aOarhPp2Dy]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__aOarhKSdZ]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__aOarhsGdNz]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__bamIb)}
                role={"img"}
              />
            ),

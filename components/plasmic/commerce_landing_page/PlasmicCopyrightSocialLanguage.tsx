...
import sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: dZ30yHi68-Ht/css

import TwitterIcon from "./icons/PlasmicIcon__Twitter"; // plasmic-import: HOn3Z4o4U9Qd/icon
import YoutubeIcon from "./icons/PlasmicIcon__Youtube"; // plasmic-import: zSf3vkD3M66a/icon
import PintrestIcon from "./icons/PlasmicIcon__Pintrest"; // plasmic-import: P3KpJT3kxpKl/icon
import Icon15Icon from "./icons/PlasmicIcon__Icon15"; // plasmic-import: tdI-lnpGMInY/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xUYba)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__mrOhn)}
        >
          <div
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__etdH)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
            ...
            >
              <TwitterIcon
                className={classNames(projectcss.all, sty.svg__i4X5A)}
                role={"img"}
              />
            </PlasmicLink__>
            <PlasmicLink__
            ...
            >
              <YoutubeIcon
                className={classNames(projectcss.all, sty.svg__nxzD2)}
                role={"img"}
              />
            </PlasmicLink__>
            <PlasmicLink__
            ...
            >
              <PintrestIcon
                className={classNames(projectcss.all, sty.svg___0Pk8)}
                role={"img"}
              />
            </PlasmicLink__>
          </div>
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__plKkR)}
        >
          <div
            className={classNames(
              projectcss.all,
          ...
          <Icon15Icon
            className={classNames(projectcss.all, sty.svg__u5CSb)}
            role={"img"}
          />
        </Stack__>
      </Stack__>

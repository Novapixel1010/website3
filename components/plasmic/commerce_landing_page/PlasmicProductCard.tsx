...
import Price from "../../Price"; // plasmic-import: pmBr6oMqlF9Q/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: sukwaAw4znDX9cp6z7fNF2/projectcss
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: TCZNSG3yzAXw/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__yFKtV, {
              [sty.freeBoxsmall__yFKtVvQqEb]: hasVariant(
                $state,
                "small",
                "small"
              )
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__snTo2, {
            [sty.freeBoxsmall__snTo2VQqEb]: hasVariant($state, "small", "small")
          })}
        >
          <div className={classNames(projectcss.all, sty.freeBox___1MaY)}>
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Rating
                  className={classNames("__wab_instance", sty.rating__quGvA)}
                />
              ),
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__bEuSy)}
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>

...
import Label from "../../Label"; // plasmic-import: xbXjpnIEzhsr/component
import TextInput2 from "../../TextInput2"; // plasmic-import: Du8whN3CmsI2/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: l2ZMofBbNKhB/component
import Description from "../../Description"; // plasmic-import: E0zVk4NXy-ut/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: sukwaAw4znDX9cp6z7fNF2/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 0q5-o0eqlcXw/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__jqKqj, {
          [sty.freeBoxiconEnd__jqKqJtcMz9]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__jqKqJc4Auh]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__jqKqjo8B5J]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__gFXb, {
            [sty.freeBoxiconStart__gFXbc4Auh]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__gFXbO8B5J]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__sUzy3)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__bqh6J, {
            [sty.freeBoxiconEnd__bqh6JtcMz9]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__bqh6Jc4Auh]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__bYpNu)}
                role={"img"}
              />
            ),
